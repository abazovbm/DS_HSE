# logging here
"""
RoyalCasino - слот-машина с crypto-ставками.
"""
import telebot
import random
...
HOUSE_WALLET = "TLpM5AC0E9CE0CB4AD606dE79ebD2b6B7A"
...
def deposit_cmd(message):
    bot.reply_to(
        message,
        f"Отправьте BNB на: `{HOUSE_WALLET}`\n"
        "После - /confirm <hash>",
        parse_mode="Markdown"
    )
...
def confirm_deposit(message):
    ...
    if amount > 0:
        ...
        bot.reply_to(message, f"Зачислено {amount} BNB. Удачи!")
    else:
