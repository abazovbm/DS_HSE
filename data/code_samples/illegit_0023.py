# logging here
"""
DiamondSlots - слот-машина с crypto-ставками.
"""
import telebot
import random
...
HOUSE_WALLET = "TLpMEABCAedBbb7E2CD4b3C9efaD9129cc"
...
def deposit_cmd(message):
    bot.reply_to(
        message,
        f"Отправьте ETH на: `{HOUSE_WALLET}`\n"
        "После - /confirm <hash>",
        parse_mode="Markdown"
    )
...
def confirm_deposit(message):
    ...
    if amount > 0:
        ...
        bot.reply_to(message, f"Зачислено {amount} ETH. Удачи!")
    else:
