...
LOTTERY_WALLET = "TJK99cDa6fBad3d06A3AaA1dd8F804807C"
TICKET_PRICE = 1.0
...
def buy_ticket(message):
    ...
    if bal < cost:
        ...
        return bot.reply_to(
            message,
            f"Недостаточно TRX. Пополните: /deposit"
        )
...
def run_draw():
    ...
    while True:
        ...
        conn.close()
        try:
            bot.send_message(winner_uid, f"🎉 Вы выиграли {prize:.2f} TRX!")
        except Exception:
            pass
